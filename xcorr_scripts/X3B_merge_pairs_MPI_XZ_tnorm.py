...
CCFDIR    = os.path.join(rootpath,'CCF_XZ_tnorm')                            # dir where CC data is stored
MERGEDIR  = os.path.join(rootpath,'MERGED_XZ_tnorm')                          # dir where stacked data is going to
