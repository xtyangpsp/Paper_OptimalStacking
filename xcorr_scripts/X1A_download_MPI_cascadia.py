...
direc  = os.path.join(rootpath,'Raw_cascadia')                   # where to store the downloaded data
...
lamin,lamax,lomin,lomax= 39,52,-132,-116                # regional box: min lat, min lon, max lat, max lon (-114.0)
chan_list = ["BHZ","HHZ"]
net_list  = ["7D","TA"]                                              # network list
sta_list  = ["*"]                                               # station (using a station list is way either compared to specifying stations one by one)
start_date = "2011_10_01_0_0_0"                               # start date of download
end_date   = "2012_08_01_0_0_0"                               # end date of download
