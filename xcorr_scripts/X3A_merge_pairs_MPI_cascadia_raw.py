...
CCFDIR    = os.path.join(rootpath,'CCF_cascadia_raw')                            # dir where CC data is stored
MERGEDIR  = os.path.join(rootpath,'MERGED_cascadia_raw')                          # dir where stacked data is going to
